...
function openAbout(){
    ...
    <div>
            ...
            <br>I welcome the use of story, intuition, art, dreams, and history in therapy, and recognize that community resources are often helpful. I offer EMDR (Eye Movement Desensitization and Reprocessing), clinical hypnosis, and relaxation techniques to treat the effects of traumatic and chronic stress, and I incorporate a life-span development, family systems, and a social context perspective. <br>
            ...
            <br>My fee is $130.00 a session unless I have a contract with your health insurance company.  I accept the following insurances: Blue Cross/Blue Shield, Harvard Pilgrim, Cigna, and Medicare. I am willing to discuss a sliding fee in certain circumstances.<br>
            <br><br><br>
            <b>Please do not hesitate to contact me if you have questions: 603-436-4111</b>
            </p>
    </div>
</div>`;
}
...
function openNightOut(){
    ...
    <div class="TNO">
        <p class="TNO">
        Therapists’ Night Out (TNO) is a free peer supervision, support, and educational group for mental health professionals that’s been meeting eight times a year since 2014.
        <br><br>
...
function openSelfHelp(){
    ...
    <h1 align="center"><b>Resources for Self Help</b></h1>
    <br>
    <center>
